"""Keyword Arguments = arduments preceded by an identifier when we pass them to a function 
                     the order of the arguments doesn't matter, unlike positonal arguments
